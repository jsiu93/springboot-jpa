...
public class BeanCopyUtil {
	...
	public static void setPropertiyes(Object obj, List<String[]> props) throws Exception {
		for(String[] prop:props) {
			BeanUtils.setProperty(obj, prop[0], prop[1]);
		}
		
	}
	
	public static <E> E setPropertiyes(E obj, String url) throws Exception {
		...
		for(String p:params) {
			...
			String value = (p.length() == idx + 1 ? "" : p.substring(idx + 1));
		...
		copier.copy(source, target, new Converter() {
			...
			public Object convert(Object srcProperty,
				...
				if (srcProperty == null) {
					...
					if(targetPropertyClass.equals(String.class) && srcProperty != null) {
					...
					try {
						...
						targetFieldName = StringUtils.uncapitalise(targetFieldName);
